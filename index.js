...
document.getElementById('start').addEventListener('click', function () {
    ...
    if (inputPlayer1.value.trim() !== "" && inputPlayer2.value.trim() !== "") {
        initializeGame()
        h2Element.style.display = 'block';
        startButton.textContent = 'Recomeçar'
    } else {
        alert("Por favor, preencha os nomes dos dois jogadores antes de começar o jogo.")
    }
})
...
function handleBoardClick(ev) {
    ...
    const h2Content = document.querySelector('h2').innerHTML
    if (h2Content.includes('venceu') || h2Content.includes('Empate')) {
        return
    }
...
document.getElementById("themeSwitcher").addEventListener("click", function () {
    ...
    if (main.dataset.theme === "dark") {
        ...
        root.style.setProperty("--quadrado-color", "#212529");
        ...
        root.style.setProperty("--quadrado-color", "#ddd");
